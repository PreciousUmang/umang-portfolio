...
function GetStarted () {
  ...
  return (
    ...
    >
      ...
      <h1  className='my-5 font-semibold text-center text-wrap sm:text-[40px] md:text-[60px] lg:text-[70px]'>Ready to get started in building something exceptional?</h1>
      <MotionButton/>
    </motion.div>
  )
}
