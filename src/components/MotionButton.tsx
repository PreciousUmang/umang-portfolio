        ...
        {isOpen && (
          ...
          >
            <a href='mailto:umang@technologist.com' target='_blank'>
              <motion.div
                whileHover={{ scale: 1.1, color: '#1e90ff', borderRadius: '50%', boxShadow: '0 0 10px rgba(30, 144, 255, 0.5)' }}
                whileTap={{ scale: 0.9 }}
                transition={{ duration: 0.3 }}
            ...
            <a href='https://www.upwork.com/freelancers/~0102c9a268bbd107bb' target='_blank'>
              <motion.div
